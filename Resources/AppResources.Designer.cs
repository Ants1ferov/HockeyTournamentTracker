...
public static class AppResources
{
    ...
    public static string TabStatistics => GetString(nameof(TabStatistics));
    public static string StatisticsTabHint => GetString(nameof(StatisticsTabHint));
    public static string OpenStatistics => GetString(nameof(OpenStatistics));
    public static string GroupZonesTitle => GetString(nameof(GroupZonesTitle));
    public static string ZoneUnusedWarning => GetString(nameof(ZoneUnusedWarning));
    public static string ChangeColor => GetString(nameof(ChangeColor));
    public static string StatsPeriod1Title => GetString(nameof(StatsPeriod1Title));
    public static string StatsPeriod2Title => GetString(nameof(StatsPeriod2Title));
    public static string StatsPeriod3Title => GetString(nameof(StatsPeriod3Title));
    public static string StatsGoalsForTitle => GetString(nameof(StatsGoalsForTitle));
    public static string StatsGoalsAgainstTitle => GetString(nameof(StatsGoalsAgainstTitle));
    public static string StatsDashboardTitle => GetString(nameof(StatsDashboardTitle));
